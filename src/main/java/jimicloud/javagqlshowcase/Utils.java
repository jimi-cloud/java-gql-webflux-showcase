package jimicloud.javagqlshowcase;
...
public class Utils {
    ...
    public static boolean isSaturday(@NonNull LocalDate localDate) {
        return localDate.getDayOfWeek() == SATURDAY;
    }

    public static boolean isSunday(@NonNull LocalDate localDate) {
        return localDate.getDayOfWeek() == SUNDAY;
    }
    ...
    public static boolean isHoliday(@NonNull LocalDate localDate, @NonNull List<Holiday> holidays) {
